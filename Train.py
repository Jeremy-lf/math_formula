...
datasets=['./training_data/testing.pkl','./training_data/value_normal_merge_1.txt']
valid_datasets=['./training_data/testing.pkl', './training_data/value_normal_merge_1.txt']
dictionaries=['./dictionary_2.txt']
...
for epoch in range(200):
    ...
    if (sacc > exprate):
        ...
        torch.save(encoder.state_dict(), 'model/encoder_lr%.5f_GN_te1_d05_SGD_bs6_mask_conv_bn_b_xavier_1.pkl'%(lr_rate))
        torch.save(attn_decoder1.state_dict(), 'model/attn_decoder_lr%.5f_GN_te1_d05_SGD_bs6_mask_conv_bn_b_xavier_1.pkl'%(lr_rate))
        print("done")
        flag = 0
    else:
        flag = flag+1
